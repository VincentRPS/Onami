...
"""
onami.features.voice
~~~~~~~~~~~~~~~~~~~~~~~

The onami core voice-related commands.
...
class VoiceFeature(Feature):
    ...
    @Feature.Command(parent="oni_voice", name="disconnect", aliases=["dc"])
    async def oni_vc_disconnect(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="oni_voice", name="stop")
    async def oni_vc_stop(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="oni_voice", name="pause")
    async def oni_vc_pause(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="oni_voice", name="resume")
    async def oni_vc_resume(self, ctx: commands.Context):
        """
    ...
    @Feature.Command(parent="oni_voice", name="volume")
    async def oni_vc_volume(self, ctx: commands.Context, *, percentage: float):
        """
    ...
    @Feature.Command(parent="oni_voice", name="play", aliases=["play_local"])
    async def oni_vc_play(self, ctx: commands.Context, *, uri: str):
        """
