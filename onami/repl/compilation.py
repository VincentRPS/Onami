...
from onami.repl.scope import Scope
from onami.repl.walkers import KeywordTransformer
...
async def _repl_coroutine({{0}}):
    ...
    try:
        ...
        onami = None  # keep working even if in panic recovery mode
